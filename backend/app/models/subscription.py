...
class Subscription(Base):
    ...
    status = Column(Enum(SubscriptionStatus, name='subscription-status'), nullable=False, default=SubscriptionStatus.INACTIVE)
    billing_frequency = Column(Enum(BillingFrequency, name='billing-frequency'), nullable=False)
    ...
    cancel_enum_reason = Column(Enum(CancelEnumReason, name='cancel-reason'), default=CancelEnumReason.UNSPECIFIED)
